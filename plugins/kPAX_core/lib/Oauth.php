...
class KpaxOAuthSignatureMethod_RSA_SHA1 extends OAuthSignatureMethod_RSA_SHA1 {
    ...
    public function fetch_private_cert(&$request) {
        // SECURITY: a live RSA private key used to be hardcoded here and committed
        // to source control. It has been removed; the key must now be supplied
        // out-of-band (e.g. via the KPAX_RSA_PRIVATE_KEY_PATH environment variable
        // pointing at a PEM file that is NOT checked into the repository).
        $path = getenv('KPAX_RSA_PRIVATE_KEY_PATH');
