...
class kpaxSrv {
    ...
    private $key;
    private $username;
    // SECURITY: do not commit real API keys. Provide via configuration/environment.
    // The previously committed key has been removed and must be rotated on the server.
    private $apiKey = "REPLACE_WITH_ELGG_API_KEY";// API key generated by elgg (load from config/env)
