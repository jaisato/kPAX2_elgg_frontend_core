	...
	<body>
		...
		<table id="t1" style="width:100%">
				...
				<tr>
					...
					<td><a href="view/<?=$game->guid;?>/<?=$title;?>"><?php echo elgg_view_icon('eye fa-lg');?></a>View</td>
					<td><a href="edit/<?=$game->guid;?>"><?php echo elgg_view_icon('pencil-square-o fa-lg');?></a>Edit</td>
					<td><a href="delete/<?=$game->guid;?>"><?php echo elgg_view_icon('trash fa-lg');?></a>Delete</td>
				</tr>
				<?php
					}
				?>
