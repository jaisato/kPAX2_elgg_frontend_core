...
$css_url = elgg_get_simplecache_url('font-awesome-4.7.0/css/font-awesome.min.css');
elgg_register_css('my_dev_games_style', $css_url);
elgg_load_css('my_dev_games_style');
